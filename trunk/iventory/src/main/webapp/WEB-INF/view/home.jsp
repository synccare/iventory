...
<%@ taglib uri="http://displaytag.sf.net" prefix="display" %>
 ...
 <section class="content-header">
     <h1>
         Dashboard
         <small><spring:message code="greeting" /></small>
     </h1>
     <ol class="breadcrumb">
...
<!--                      </div> -->
         ...
         <div class="col-lg-4 col-xs-12">
             ...
             <div class="box-body table-responsive no-padding table-bordered">
	            <display:table name="someList" class="table table-hover">
				  <display:column property="mail" headerClass="thead-inverse"/>
				  <display:column property="total" headerClass="thead-inverse"/>
         ...
         <section class="col-lg-6 connectedSortable">
             ...
             <div class="box box-success">
                 ...
                 <div class="box-body chat" id="chat-box">
                     ...
                     <!-- chat item -->
                     <div class="item">
                         <img src="images/avatar5.png" alt="user image" class="offline"/>
                         <p class="message">
                             <a href="#" class="name">
...
<!--                     
                    <h3 class="text-primary mb-4"><spring:message code="greeting" /></h3>
                            ...
                            <div class="card">
                                <div class="card-block">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <th><img src="/images/temp/profile.jpg" alt="profile" class="rounded-circle" width="40"
                                                        height="40" /></th>
                                                <td>Larry</td>
                                                <td>Acer</td>
