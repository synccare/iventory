...
import com.synclones.iventory.service.SecurityService;
import com.synclones.iventory.service.UserService;
import com.synclones.iventory.validator.UserValidator;
...
public class LoginController {
	...
	public String showLoginPagePost(ModelMap model, @RequestParam String username, @RequestParam String password) {
...
//return modelAndView;
	...
	public String showWelPage(ModelMap model){
		return "welcome";
	}
